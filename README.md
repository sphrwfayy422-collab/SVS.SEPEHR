...
<body class="bg-gray-50 text-gray-800 dark:bg-dark-bg dark:text-dark-text transition-colors duration-300 pb-24 md:pb-0">
    ...
    <script>
        window.app = {
            state: {
                lang: 'fa',
                // این لیست پیش‌فرض فقط زمانی استفاده می‌شود که سرور خاموش باشد یا کاربر آفلاین باشد
                products: [], 
                cart: [],
                wishlist: [],
                orders: [],
            ...
            init() {
                ...
                // استفاده از مسیر نسبی برای هماهنگی با پورت سرور
                fetch('/api/products/')
                .then(response => {
                ...
                .then(data => {
                    console.log("🔥 محصولات از سرور امپراتوری دریافت شد:", data);
            ...
            handleAuthSubmit(e) { 
                ...
                // حالت ورود: ارسال درخواست به سرور پایتون
                // ********* امنیت: رمز عبور به سرور فرستاده می‌شود *********
                fetch('/api/login', {
                    method: 'POST',
